...
public class MyOrderedOrderDetailsAdapter extends RecyclerView.Adapter<MyOrderedOrderDetailsAdapter.ViewHolder> {
    private String value;
    private int position;
    private List<MyOrderDatum> data;
    private Activity activity;

    public MyOrderedOrderDetailsAdapter(List<MyOrderDatum> data, Activity activity, String value, int position) {
        this.data = data;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyOrderedOrderDetailsAdapter.ViewHolder viewHolder = new MyOrderedOrderDetailsAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @RequiresApi(api = Build.VERSION_CODES.O)
    @Override
    public void onBindViewHolder(MyOrderedOrderDetailsAdapter.ViewHolder holder, int position) {
...
//        return data.get(position).getStatus().length();
        return data.size();
    }
