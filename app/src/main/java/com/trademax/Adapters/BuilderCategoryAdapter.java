...
public class BuilderCategoryAdapter extends RecyclerView.Adapter<BuilderCategoryAdapter.ViewHolder>{
    private String listdata;
    private Activity activity;

    // RecyclerView recyclerView;
    public BuilderCategoryAdapter(String listdata, Activity activity) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.builder_category_item, parent, false);
