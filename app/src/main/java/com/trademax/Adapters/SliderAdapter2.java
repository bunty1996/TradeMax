...
import com.trademax.Models.HomeGetAll.GetAllProductsProductFile;
...
public class SliderAdapter2 extends PagerAdapter {
    ...
    private final List<GetAllProductsProductFile> mImageResources;
    private Activity activity;

    public SliderAdapter2(Activity activity, List<GetAllProductsProductFile> mImageResources) {
