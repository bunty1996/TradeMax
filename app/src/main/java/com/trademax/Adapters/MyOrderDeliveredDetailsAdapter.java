...
public class MyOrderDeliveredDetailsAdapter extends RecyclerView.Adapter<MyOrderDeliveredDetailsAdapter.ViewHolder> {
    private String value;
    private int position;
    private List<MyOrderDatum> data;
    private Activity activity;

    public MyOrderDeliveredDetailsAdapter(List<MyOrderDatum> data, Activity activity, String value, int position) {
        this.data = data;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyOrderDeliveredDetailsAdapter.ViewHolder viewHolder = new MyOrderDeliveredDetailsAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @RequiresApi(api = Build.VERSION_CODES.O)
    @Override
    public void onBindViewHolder(MyOrderDeliveredDetailsAdapter.ViewHolder holder, int position) {
