...
public class Painter_PlasterGridAdapter extends BaseAdapter {

    private ArrayList<ProductBySubCatItem> productBySubCatItemList;
    ...
    public Painter_PlasterGridAdapter(Activity activity, ArrayList<ProductBySubCatItem> productBySubCatItemList) {
