...
public class MyOrderShippedDetailsAdapter extends RecyclerView.Adapter<MyOrderShippedDetailsAdapter.ViewHolder> {
    private String value;
    private int position;
    private List<MyOrderDatum> data;
    private Activity activity;

    public MyOrderShippedDetailsAdapter(List<MyOrderDatum> data, Activity activity, String value, int position) {
        this.data = data;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyOrderShippedDetailsAdapter.ViewHolder viewHolder = new MyOrderShippedDetailsAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @RequiresApi(api = Build.VERSION_CODES.O)
    @Override
    public void onBindViewHolder(MyOrderShippedDetailsAdapter.ViewHolder holder, int position) {
